...
@section('content')
    ...
    <section
        class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-gray-900 to-blue-900">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-6 text-center text-white">
            <div data-aos="fade-up" data-aos-duration="1000" data-aos-once="true">
                ...
                <p class="text-xl md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto leading-relaxed">
                    Mengutamakan presisi dan keahlian dalam setiap proyek konstruksi besi untuk hasil yang maksimal dan
                    tahan lama
                </p>
        ...
        <!-- Scroll indicator -->
        <div class="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10" data-aos="fade-up" data-aos-delay="500" data-aos-once="true">
        ...
        <div class="max-w-7xl mx-auto px-6">
            <div class="grid grid-cols-2 md:grid-cols-4 gap-8">
                <div class="text-center group" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                    <div
                        class="bg-gradient-to-br from-blue-500 to-cyan-400 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                ...
                <div class="text-center group" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="100">
                    <div
                        class="bg-gradient-to-br from-blue-500 to-cyan-400 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                ...
                <div class="text-center group" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="200">
                    <div
                        class="bg-gradient-to-br from-blue-500 to-cyan-400 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                ...
                <div class="text-center group" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="300">
                    <div
                        class="bg-gradient-to-br from-blue-500 to-cyan-400 w-20 h-20 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300 shadow-lg">
    ...
    <section class="py-20 bg-gray-50" id="services">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 group"
                    data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                    <div
                        class="bg-gradient-to-br from-blue-100 to-cyan-100 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 group"
                    data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="100">
                    <div
                        class="bg-gradient-to-br from-blue-100 to-cyan-100 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                ...
                <div class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-500 group"
                    data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="200">
                    <div
                        class="bg-gradient-to-br from-blue-100 to-cyan-100 w-16 h-16 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
    ...
    <section class="py-20 bg-white" id="projects">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                @foreach ($projectImages as $index => $image)
                    <div
                        ...
                        data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="{{ $index * 100 }}">
                        <div class="aspect-w-16 aspect-h-12 bg-gray-200 overflow-hidden">
                            <img src="{{ asset('images/projects/' . $image) }}" alt="{{ $image }}"
            ...
            <div class="text-center mt-12" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
    ...
    <section class="py-20 bg-gradient-to-br from-gray-900 to-blue-900 text-white" id="values">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                <div class="text-center group" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
                    <div
                        class="bg-white/10 backdrop-blur-sm w-24 h-24 rounded-3xl flex items-center justify-center mx-auto mb-6 group-hover:bg-cyan-500/20 transition-all duration-300 border border-white/20">
    ...
    <section class="py-20 bg-gradient-to-br from-gray-900 to-blue-900 text-white" id="quote">
        <div class="max-w-4xl mx-auto px-6">
            <div class="text-center mb-12" data-aos="fade-up" data-aos-anchor-placement="top-bottom">
            ...
            <div class="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20" data-aos="fade-up"
                ...
                <form action="#" method="POST" class="grid md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="700">
                    ...
                    <div class="md:col-span-2 text-center" data-aos="fade-up" data-aos-anchor-placement="top-bottom" data-aos-delay="800">
                        <button type="submit"
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            AOS.init({
                duration: 800,
                easing: 'ease-in-out',
                once: false, // Biarkan false agar animasi bisa berulang
                mirror: true, // Ini yang membuat animasi keluar saat scroll keluar dari viewport
                offset: 100,
            ...
            // Refresh AOS pada event tertentu untuk memastikan animasi berjalan smooth
